...
namespace project.BLL.Abstract
{
    public interface IPostService
    {
        ...
        Task<IEnumerable<Post>> GetRandomPostsForNewsFeedAsync(string currentUserId);
        ...
        /// <summary>
        /// Deletes a post of a user asynchronously based on the post ID.
        /// </summary>
        /// <param name="userId">The ID of the user whose posts will be deleted.</param>
        /// <returns>Task representing the asynchronous operation.</returns>
        Task DeleteUserPostAsync(string postId);
