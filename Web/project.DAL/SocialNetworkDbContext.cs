...
namespace project.common.Core.Concrete.EntityFramework
{
    /// <summary>
    ...
    /// </summary>
    public partial class SocialNetworkDbContext : IdentityDbContext<User, Role, string>
    {
        /// <summary>
        /// Initializes a new instance of the DbContext class with the specified DbContextOptions.
        /// </summary>
        /// <param name="contextOptions">The options for configuring the DbContext.</param>
        public SocialNetworkDbContext(DbContextOptions<SocialNetworkDbContext> contextOptions) : base(contextOptions)
        {
        }
